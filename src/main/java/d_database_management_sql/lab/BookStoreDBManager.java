...
public class BookStoreDBManager {
    ...
    public static void addGenreColumn(Connection conn) {
        try {
            ...
            String alterTableQuery = "ALTER TABLE books ADD COLUMN genre VARCHAR(20)";
    ...
    public static void modifyPricePrecision(Connection conn) {
        try {
            ...
            String modifyQuery = "ALTER TABLE books MODIFY COLUMN price DECIMAL(8, 2)";
    ...
    public static void addPublishedDateColumn(Connection conn) {
        try {
            ...
            String alterTableQuery = "ALTER TABLE books ADD COLUMN published_date DATE";
            ...
            String insertQuery = "INSERT INTO books (title, author, price, published_date) VALUES ('The Great Gatsby', 'F.Scott Fitzgerald', 10.99, '1925-04-10')";
    ...
    public static void dropAuthorColumn(Connection conn) {
        try {
            ...
            String dropColumnQuery = "ALTER TABLE books DROP COLUMN author";

            /*TODO 11: execute the SQL query using stmt.executeUpdate() to remove the column */
            stmt.execute(dropColumnQuery);

...
import b_programming_with_java.serialization.Player;
...
public class Main {
                    ...
                    do {
                        ...
                        switch (menuChoice) {
                            ...
                            case 2:
                                ...
                                System.out.printf("Age: %d%nHeight: %d%nWeight: %d%n", dolphinObject.getAge(), dolphinObject.getHeight(), dolphinObject.getWeight());;
                                System.out.printf("Color: %s%nSpeed: %d%n", dolphinObject.getColor(), dolphinObject.getSwimmingSpeed());
                                break;
                            case 3:
                    ...
                    do {
                        ...
                        switch (menuChoice) {
                            ...
                            case 2:
                                ...
                                System.out.printf("Age: %d%nHeight: %d%nWeight: %d%n", penguinObject.getAge(), penguinObject.getHeight(), penguinObject.getWeight());
                                System.out.printf("Walking Speed: %d%nSwimming Speed: %d%n", penguinObject.getWalkSpeed(), penguinObject.getSwimSpeed());
                                break;
                            case 3:
    ...
    public static void writeObjectsToFile(Tiger tiger, Penguin penguin, Dolphin dolphin){
        try(FileOutputStream fileTigerOutputStream = new FileOutputStream("tiger.txt");
            ObjectOutputStream objectTigerOutputStream = new ObjectOutputStream(fileTigerOutputStream);
            FileOutputStream filePenguinOutputStream = new FileOutputStream("penguin.txt");
            ObjectOutputStream objectPenguinOutputStream = new ObjectOutputStream(filePenguinOutputStream);
            FileOutputStream fileDolphinOutputStream = new FileOutputStream("dolphin.txt");
            ObjectOutputStream objectDolphinOutputStream = new ObjectOutputStream(fileDolphinOutputStream);
        )
        {
            objectTigerOutputStream.writeObject(tiger);
            System.out.println("Tiger object serialized and saved to tiger.txt");

            objectPenguinOutputStream.writeObject(penguin);
            System.out.println("Penguin object serialized and saved to penguin.txt");

            objectDolphinOutputStream.writeObject(dolphin);
            System.out.println("Dolphin object serialized and saved to dolphin.txt");
        }
    ...
    public static void readObjectsFromFile() {
        Tiger restoredTiger;
        Penguin restoredPenguin;
        Dolphin restoredDolphin;
        try(FileInputStream fileTigerInputStream = new FileInputStream("tiger.txt");
            ObjectInputStream objectTigerInputStream = new ObjectInputStream(fileTigerInputStream);
            FileInputStream filePenguinInputStream = new FileInputStream("penguin.txt");
            ObjectInputStream objectPenguinInputStream = new ObjectInputStream(filePenguinInputStream);
            FileInputStream fileDolphinInputStream = new FileInputStream("dolphin.txt");
            ObjectInputStream objectDolphinInputStream = new ObjectInputStream(fileDolphinInputStream);
        )
        {
            Object restoredObject = objectTigerInputStream.readObject();
            restoredTiger = (Tiger) restoredObject;
            System.out.println("Restored Tiger = " + restoredTiger);

            restoredObject = objectPenguinInputStream.readObject();
            restoredPenguin = (Penguin) restoredObject;
            System.out.println("Restored Penguin = " + restoredPenguin);

            restoredObject = objectDolphinInputStream.readObject();
            restoredDolphin = (Dolphin) restoredObject;
            System.out.println("Restored Dolphin = " + restoredDolphin);
        }
        catch (FileNotFoundException e) {
            System.err.println("File Not Found");
        }
